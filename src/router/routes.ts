...
import DateTime from '@/views/Settings/DateTime.vue';
import EventLogs from '@/views/Logs/EventLogs.vue';
import FactoryReset from '@/views/Operations/FactoryReset.vue';
import Firmware from '@/views/Operations/Firmware.vue';
import Inventory from '@/views/HardwareStatus/Inventory.vue';
import Kvm from '@/views/Operations/Kvm.vue';
import KvmConsole from '@/views/Operations/Kvm/KvmConsole.vue';
import Sessions from '../views/SecurityAndAccess/Sessions.vue';
import Ldap from '@/views/SecurityAndAccess/Ldap.vue';
...
import PostCodeLogs from '@/views/Logs/PostCodeLogs.vue';
import PowerRestorePolicy from '@/views/Settings/PowerRestorePolicy.vue';
import ProfileSettings from '@/views/ProfileSettings.vue';
import RebootBmc from '@/views/Operations/RebootBmc.vue';
import Policies from '@/views/SecurityAndAccess/Policies.vue';
import Sensors from '@/views/HardwareStatus/Sensors.vue';
import SerialOverLan from '@/views/Operations/SerialOverLan.vue';
import SerialOverLanConsole from '@/views/Operations/SerialOverLan/SerialOverLanConsole.vue';
