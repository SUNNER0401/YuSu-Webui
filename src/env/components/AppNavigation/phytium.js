      ...
      navigationItems: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              id: 'operating-logs',
              label: this.$t('appNavigation.operatingLogs'),
              route: '/logs/operating-logs',
            },
            {
              id: 'ras-logs',
              label: this.$t('appNavigation.rasLogs'),
              route: '/logs/ras-logs',
            },
          ],
        },
        ...
        },
        {
          ...
          children: [
            ...
            {
              id: 'alarm-setting',
              label: this.$t('appNavigation.alarmSetting'),
              route: '/settings/alarm-setting',
            },
          ],
        },
        {
